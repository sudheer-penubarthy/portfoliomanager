...
import com.sudheer.portfoliotracker.repository.FundHouseRepository;
import com.sudheer.portfoliotracker.domain.service.impl.AmfiPersistServiceImpl;
...
class AmfiIngestServiceTest {
    ...
    private AmfiPersistServiceImpl persistService;
    ...
    void setup() {
        ...
        persistService = mock(AmfiPersistServiceImpl.class);
